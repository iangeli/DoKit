...
- (void)doraemon_showIntAlertAndAutomicSetWithKeyPath:(NSString *)keyPath {
    ...
    [self doraemon_showTextFieldAlertWithText:[NSString stringWithFormat:@"%@", [self valueForKeyPath:keyPath]]
...
- (void)doraemon_showFrameAlertAndAutomicSetWithKeyPath:(NSString *)keyPath {
    ...
    __weak typeof(self) weakSelf = self;
    [self doraemon_showTextFieldAlertWithText:NSStringFromCGRect([value CGRectValue])
                                      handler:^(NSString *_Nullable newText) {
...
- (void)doraemon_showColorAlertAndAutomicSetWithKeyPath:(NSString *)keyPath {
    ...
    __weak typeof(self) weakSelf = self;
    [self doraemon_showTextFieldAlertWithText:[color doraemon_HexString]
                                      handler:^(NSString *_Nullable newText) {
...
- (void)doraemon_showFontAlertAndAutomicSetWithKeyPath:(NSString *)keyPath {
    ...
    __weak typeof(self) weakSelf = self;
    [self doraemon_showTextFieldAlertWithText:[DoraemonHierarchyFormatterTool formatNumber:@(font.pointSize)]
                                      handler:^(NSString *_Nullable newText) {
...
- (void)doraemon_showDoubleAlertAndAutomicSetWithKeyPath:(NSString *)keyPath {
    __weak typeof(self) weakSelf = self;
    [self doraemon_showTextFieldAlertWithText:[DoraemonHierarchyFormatterTool formatNumber:[self valueForKeyPath:keyPath]]
                                      handler:^(NSString *_Nullable newText) {
...
- (void)doraemon_showPointAlertAndAutomicSetWithKeyPath:(NSString *)keyPath {
    __block NSValue *value = [self valueForKeyPath:keyPath];
    __weak typeof(self) weakSelf = self;
    [self doraemon_showTextFieldAlertWithText:NSStringFromCGPoint([value CGPointValue])
                                      handler:^(NSString *_Nullable newText) {
...
- (void)doraemon_showEdgeInsetsAndAutomicSetWithKeyPath:(NSString *)keyPath {
    __block NSValue *value = [self valueForKeyPath:keyPath];
    __weak typeof(self) weakSelf = self;
    [self doraemon_showTextFieldAlertWithText:NSStringFromUIEdgeInsets([value UIEdgeInsetsValue])
                                      handler:^(NSString *_Nullable newText) {
...
- (void)doraemon_showTextAlertAndAutomicSetWithKeyPath:(NSString *)keyPath {
    __weak typeof(self) weakSelf = self;
    [self doraemon_showTextFieldAlertWithText:[self valueForKeyPath:keyPath]
                                      handler:^(NSString *_Nullable newText) {
...
- (void)doraemon_showAttributeTextAlertAndAutomicSetWithKeyPath:(NSString *)keyPath {
    ...
    __weak typeof(self) weakSelf = self;
    [self doraemon_showTextFieldAlertWithText:attribute.string
                                      handler:^(NSString *_Nullable newText) {
...
- (void)doraemon_showSizeAlertAndAutomicSetWithKeyPath:(NSString *)keyPath {
    __block NSValue *value = [self valueForKeyPath:keyPath];
    __weak typeof(self) weakSelf = self;
    [self doraemon_showTextFieldAlertWithText:NSStringFromCGSize([value CGSizeValue])
                                      handler:^(NSString *_Nullable newText) {
...
- (void)doraemon_showDateAlertAndAutomicSetWithKeyPath:(NSString *)keyPath {
    ...
    __weak typeof(self) weakSelf = self;
    [self doraemon_showTextFieldAlertWithText:[DoraemonHierarchyFormatterTool stringFromDate:date]
                                      handler:^(NSString *_Nullable newText) {
...
- (void)doraemon_showTextFieldAlertWithText:(NSString *)text handler:(nullable void (^)(NSString *_Nullable newText))handler {
    ...
    [window.rootViewController.doraemon_currentShowingViewController doraemon_showTextFieldAlertControllerWithMessage:@"Change Property"
                                                                                                                 text:text
                                                                                                              handler:^(NSString *_Nullable newText) {
                                                                                                                  if (handler) {
                                                                                                                      handler(newText);
...
- (void)doraemon_showActionSheetWithActions:(NSArray *)actions currentAction:(NSString *)currentAction completion:(void (^)(NSInteger index))completion {
    __weak typeof(self) weakSelf = self;
    UIWindow *window = (UIWindow *)[DoraemonHierarchyHelper shared].window;
    [window.rootViewController.doraemon_currentShowingViewController doraemon_showActionSheetWithTitle:@"Change Property"
                                                                                               actions:actions
...
- (NSArray<DoraemonHierarchyCategoryModel *> *)doraemon_sizeHierarchyCategoryModels {
    ...
    for (NSLayoutConstraint *constrain in self.constraints) {
        ...
        if (constrainDesc) {
            ...
            mod.block = ^{
                [weakSelf doraemon_showTextFieldAlertWithText:[DoraemonHierarchyFormatterTool formatNumber:@(cons.constant)]
                                                      handler:^(NSString *_Nullable newText) {
...
- (NSArray<DoraemonHierarchyCategoryModel *> *)doraemon_hierarchyCategoryModels {
    ...
    model3.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription viewContentModeDescriptions]
                                        currentAction:[DoraemonEnumDescription viewContentModeDescription:weakSelf.contentMode]
                                           completion:^(NSInteger index) {
...
- (NSArray<DoraemonHierarchyCategoryModel *> *)doraemon_hierarchyCategoryModels {
    ...
    model5.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription textAlignments]
                                        currentAction:[DoraemonEnumDescription textAlignmentDescription:weakSelf.textAlignment]
                                           completion:^(NSInteger index) {
    ...
    model9.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription baselineAdjustments]
                                        currentAction:[DoraemonEnumDescription baselineAdjustmentDescription:weakSelf.baselineAdjustment]
                                           completion:^(NSInteger index) {
    ...
    model10.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription lineBreaks]
                                        currentAction:[DoraemonEnumDescription lineBreakModeDescription:weakSelf.lineBreakMode]
                                           completion:^(NSInteger index) {
...
- (NSArray<DoraemonHierarchyCategoryModel *> *)doraemon_hierarchyCategoryModels {
    ...
    model1.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription controlContentHorizontalAlignments]
                                        currentAction:[DoraemonEnumDescription controlContentHorizontalAlignmentDescription:weakSelf.contentHorizontalAlignment]
                                           completion:^(NSInteger index) {
    ...
    model2.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription controlContentVerticalAlignments]
                                        currentAction:[DoraemonEnumDescription controlContentVerticalAlignmentDescription:weakSelf.contentVerticalAlignment]
                                           completion:^(NSInteger index) {
...
- (NSArray<DoraemonHierarchyCategoryModel *> *)doraemon_hierarchyCategoryModels {
    ...
    model3.block = ^{
        [weakSelf doraemon_showTextFieldAlertWithText:weakSelf.currentTitle
                                              handler:^(NSString *_Nullable newText) {
    ...
    model5.block = ^{
        [weakSelf doraemon_showTextFieldAlertWithText:[weakSelf.currentTitleColor doraemon_HexString]
                                              handler:^(NSString *_Nullable newText) {
    ...
    model6.block = ^{
        [weakSelf doraemon_showTextFieldAlertWithText:[weakSelf.currentTitleShadowColor doraemon_HexString]
                                              handler:^(NSString *_Nullable newText) {
...
- (NSArray<DoraemonHierarchyCategoryModel *> *)doraemon_hierarchyCategoryModels {
    ...
    model10.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription textBorderStyles]
                                        currentAction:[DoraemonEnumDescription textBorderStyleDescription:weakSelf.borderStyle]
                                           completion:^(NSInteger index) {
    ...
    model11.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription textFieldViewModes]
                                        currentAction:[DoraemonEnumDescription textFieldViewModeDescription:weakSelf.clearButtonMode]
                                           completion:^(NSInteger index) {
    ...
    model15.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription textAutocapitalizationTypes]
                                        currentAction:[DoraemonEnumDescription textAutocapitalizationTypeDescription:weakSelf.autocapitalizationType]
                                           completion:^(NSInteger index) {
    ...
    model16.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription textAutocorrectionTypes]
                                        currentAction:[DoraemonEnumDescription textAutocorrectionTypeDescription:weakSelf.autocorrectionType]
                                           completion:^(NSInteger index) {
    ...
    model17.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription keyboardTypes]
                                        currentAction:[DoraemonEnumDescription keyboardTypeDescription:weakSelf.keyboardType]
                                           completion:^(NSInteger index) {
    ...
    model18.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription keyboardAppearances]
                                        currentAction:[DoraemonEnumDescription keyboardAppearanceDescription:weakSelf.keyboardAppearance]
                                           completion:^(NSInteger index) {
    ...
    model19.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription returnKeyTypes]
                                        currentAction:[DoraemonEnumDescription returnKeyTypeDescription:weakSelf.returnKeyType]
                                           completion:^(NSInteger index) {
...
- (NSArray<DoraemonHierarchyCategoryModel *> *)doraemon_hierarchyCategoryModels {
    ...
    model3.block = ^{
        ...
        [weakSelf doraemon_showActionSheetWithActions:actions
...
- (NSArray<DoraemonHierarchyCategoryModel *> *)doraemon_hierarchyCategoryModels {
    ...
    model1.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription activityIndicatorViewStyles]
                                        currentAction:[DoraemonEnumDescription activityIndicatorViewStyleDescription:weakSelf.activityIndicatorViewStyle]
                                           completion:^(NSInteger index) {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
...
- (NSArray<DoraemonHierarchyCategoryModel *> *)doraemon_hierarchyCategoryModels {
    ...
    model1.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription progressViewStyles]
                                        currentAction:[DoraemonEnumDescription progressViewStyleDescription:weakSelf.progressViewStyle]
                                           completion:^(NSInteger index) {
...
- (NSArray<DoraemonHierarchyCategoryModel *> *)doraemon_hierarchyCategoryModels {
    ...
    model1.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription scrollViewIndicatorStyles]
                                        currentAction:[DoraemonEnumDescription scrollViewIndicatorStyleDescription:weakSelf.indicatorStyle]
                                           completion:^(NSInteger index) {
    ...
    model15.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription scrollViewKeyboardDismissModes]
                                        currentAction:[DoraemonEnumDescription scrollViewKeyboardDismissModeDescription:weakSelf.keyboardDismissMode]
                                           completion:^(NSInteger index) {
...
- (NSArray<DoraemonHierarchyCategoryModel *> *)doraemon_hierarchyCategoryModels {
    ...
    model3.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription tableViewCellSeparatorStyles]
                                        currentAction:[DoraemonEnumDescription tableViewCellSeparatorStyleDescription:weakSelf.separatorStyle]
                                           completion:^(NSInteger index) {
    ...
    model9.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription tableViewSeparatorInsetReferences]
                                        currentAction:[DoraemonEnumDescription tableViewSeparatorInsetReferenceDescription:weakSelf.separatorInsetReference]
                                           completion:^(NSInteger index) {
...
- (NSArray<DoraemonHierarchyCategoryModel *> *)doraemon_hierarchyCategoryModels {
    ...
    model3.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription tableViewCellSelectionStyles]
                                        currentAction:[DoraemonEnumDescription tableViewCellSelectionStyleDescription:weakSelf.selectionStyle]
                                           completion:^(NSInteger index) {
    ...
    model4.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription tableViewCellAccessoryTypes]
                                        currentAction:[DoraemonEnumDescription tableViewCellAccessoryTypeDescription:weakSelf.accessoryType]
                                           completion:^(NSInteger index) {
    ...
    model5.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription tableViewCellAccessoryTypes]
                                        currentAction:[DoraemonEnumDescription tableViewCellAccessoryTypeDescription:weakSelf.editingAccessoryType]
                                           completion:^(NSInteger index) {
...
- (NSArray<DoraemonHierarchyCategoryModel *> *)doraemon_hierarchyCategoryModels {
    ...
    model1.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription datePickerModes]
                                        currentAction:[DoraemonEnumDescription datePickerModeDescription:weakSelf.datePickerMode]
                                           completion:^(NSInteger index) {
...
- (NSArray<DoraemonHierarchyCategoryModel *> *)doraemon_hierarchyCategoryModels {
    ...
    model1.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription barStyles]
                                        currentAction:[DoraemonEnumDescription barStyleDescription:weakSelf.barStyle]
                                           completion:^(NSInteger index) {
    ...
    if (self.titleTextAttributes[NSFontAttributeName]) {
        model9.block = ^{
            ...
            [weakSelf doraemon_showTextFieldAlertWithText:[NSString stringWithFormat:@"%@", [DoraemonHierarchyFormatterTool formatNumber:@(font.pointSize)]]
                                                  handler:^(NSString *_Nullable newText) {
...
- (NSArray<DoraemonHierarchyCategoryModel *> *)doraemon_hierarchyCategoryModels {
    ...
    model7.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription tabBarItemPositionings]
                                        currentAction:[DoraemonEnumDescription tabBarItemPositioningDescription:weakSelf.itemPositioning]
                                           completion:^(NSInteger index) {
...
- (NSArray<DoraemonHierarchyCategoryModel *> *)doraemon_hierarchyCategoryModels {
    ...
    model4.block = ^{
        [weakSelf doraemon_showActionSheetWithActions:[DoraemonEnumDescription searchBarStyles]
                                        currentAction:[DoraemonEnumDescription searchBarStyleDescription:weakSelf.searchBarStyle]
                                           completion:^(NSInteger index) {

...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _titleLabel.frame = CGRectMake(kDoraemonSizeFromLandscape(32), self.doraemon_height / 2 - _titleLabel.doraemon_height / 2, _titleLabel.doraemon_width, _titleLabel.doraemon_height);

        _switchView = [[UISwitch alloc] init];
        _switchView.onTintColor = [UIColor doraemon_blue];
        _switchView.doraemon_origin = CGPointMake(self.doraemon_width - kDoraemonSizeFromLandscape(32) - _switchView.doraemon_width, self.doraemon_height / 2 - _switchView.doraemon_height / 2);

...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [[DoraemonManager shareInstance] addPluginWithTitle:DoraemonDemoLocalizedString(@"block方式加入插件")
                                                   icon:@"doraemon_default"
                                                   desc:@"测试插件"
                                             pluginName:@"pluginName"
                                               atModule:DoraemonDemoLocalizedString(@"Customize")
                                                 handle:^(NSDictionary *itemData) {

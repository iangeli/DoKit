...
- (BOOL)handleEvent:(DoraemonMCMessage *)eventInfo {
    ...
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"自定义手势"
                                                    message:message
                                                   delegate:nil
...
- (void)controlEvent {
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"点击事件测试"
                                                    message:@"我是普通警告框"
                                                   delegate:nil
                                          cancelButtonTitle:@"好的"
                                          otherButtonTitles:nil];
...
- (void)controlEvent3 {
    ...
    [alertView renderUI:DoraemonLocalizedString(@"UIControl 点击事件 自定义Alertview")
        placeholder:@[]
        inputTip:@[ DoraemonLocalizedString(@"Test case name"), DoraemonLocalizedString(@"Test person name") ]
        ok:DoraemonLocalizedString(@"Submit")
        quit:DoraemonLocalizedString(@"Discard")
        cancle:DoraemonLocalizedString(@"Cancel")
        okBlock:^{
...
- (void)showAlertMessage {
    ...
    UIAlertAction *sureAction = [UIAlertAction actionWithTitle:@"知道了"
